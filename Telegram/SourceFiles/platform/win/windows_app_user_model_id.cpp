...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"NexFort.Desktop.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"NexFort.Desktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"NexFort.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"NexFort/NexFort.lnk"_q;
	const auto old = u"NexFort for Windows/NexFort.lnk"_q;
