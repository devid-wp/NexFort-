...
- [ ] Найти основные директории UI
- [ ] Найти настройки
- [ ] Найти обработку сообщений
- [ ] Найти navigation/chat switching
- [ ] Найти hotkeys
- [ ] Найти local storage
- [ ] Найти network/update layer
- [ ] Найти AyuGram-specific код

### Dependencies

- [ ] Составить список крупных зависимостей
- [ ] Понять, какие реально нужны
- [ ] Проверить лицензии
- [ ] Проверить устаревшие зависимости
- [ ] Не удалять зависимости просто потому, что они выглядят ненужными
...
- [ ] Составить список функций AyuGram
- [ ] Пометить каждую:
  - KEEP
  - MODIFY
  - REMOVE
